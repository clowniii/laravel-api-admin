...
class ThirdLoginController extends BaseController
{
    ...
    private function doLogin(string $openid, array $userDetail): array
    {
        ...
        if (empty($userInfo)) {
            ...
            $userInfo->userData()->create($userDataArr);
        ...
        $userInfo['access'] = (new LoginController(App()))->getAccess(intval($userInfo['id']));
        $userInfo['menu']   = (new LoginController(App()))->getAccessMenuData(intval($userInfo['id']));
