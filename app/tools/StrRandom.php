...
class StrRandom
{
    ...
    public static function randomIp(): string
    {
        ...
        return $ip = long2ip(mt_rand(intval($ipLong[$randKey][0]), intval($ipLong[$randKey][1])));
    }
     ...
     * @return string
     */
    public static function randomUrl(string $protocol = ''): string
    {
     ...
     */
    public static function randomEmail(string $domain = ''): string
    {
        $len    = mt_rand(6, 16);
