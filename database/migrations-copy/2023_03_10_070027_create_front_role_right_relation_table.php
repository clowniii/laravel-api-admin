...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('front_role_right_relation', function (Blueprint $table) {
            $table->timestamps();
            ...
            //索引定义
            $table->index(['role_id', 'right_id', 'right_type']);

            $table->comment("前台用户角色权限类型表");
        });
    }
    ...
    {
        Schema::dropIfExists('front_role_right_relation');
    }
};
